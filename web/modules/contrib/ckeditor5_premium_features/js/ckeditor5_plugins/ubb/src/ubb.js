...
class Ubb {
  ...
  init() {
    ...
    if (typeof format === "undefined") {
      ...
      const baseUrl = (window.drupalSettings && window.drupalSettings.path && window.drupalSettings.path.baseUrl) ? window.drupalSettings.path.baseUrl : '/';
      const url = baseUrl.replace(/\/$/, '') + '/ckeditor5-premium-features/drupal-version/' + format;
