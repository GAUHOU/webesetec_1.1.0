    ...
    conversion.for("upcast").elementToElement({
      ...
      model: (viewElement, {writer}) => {
        ...
        if (classes.includes("col")) {
          return writer.createElement("bsGridCol");
        }

        if (viewElement.parent && viewElement.parent.hasOwnProperty("getAttribute")) {
          const parentClasses = viewElement.parent.getAttribute("class") || '';
