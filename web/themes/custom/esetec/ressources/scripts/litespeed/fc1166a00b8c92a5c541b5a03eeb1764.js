...
! function(e, t) {
    ...
    function B() {
        E.removeEventListener("DOMContentLiteSpeedLoaded", B), C.removeEventListener("load", B), S.ready()
    }
    ...
    }), S.ready.then = F.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? C.setTimeout(S.ready) : (E.addEventListener("DOMContentLiteSpeedLoaded", B), C.addEventListener("load", B));
