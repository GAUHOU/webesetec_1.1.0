    ...
    [941], {
        ...
        169: (e, t, r) => {
            ...
            var n = r(4762),
                ...
                b = e.exports = function(e, t, r) {
                    "Symbol(" === f(h(t), 0, 7) && (t = "[" + m(h(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), r && r.getter && (t = "get " + t), r && r.setter && (t = "set " + t), (!o(e, "name") || c && e.name !== t) && (a ? g(e, "name", {
                        value: t,
                        configurable: !0
                    }) : e.name = t), _ && r && o(r, "arity") && e.length !== r.arity && g(e, "length", {
                        value: r.arity
                    });
                    try {
                        r && o(r, "constructor") && r.constructor ? a && g(e, "prototype", {
                            writable: !1
                        }) : e.prototype && (e.prototype = void 0)
                    } catch (e) {}
                    var n = d(e);
                    return o(n, "source") || (n.source = v(y, "string" == typeof t ? t : "")), e
                };
        ...
        555: (e, t, r) => {
            ...
            class TopBarTracking extends s.default {
                ...
                static waitForTopBar() {
                    ...
                    const t = this.addObserver(document.body, {
                            childList: !0,
                            subtree: !0
                        }, () => {
                            const e = document.querySelector(o);
                            e && (this.attachTopBarTracking(e), t.disconnect(), clearTimeout(r))
                        }),
                        r = setTimeout(() => {
                            t.disconnect()
                        }, 1e4)
                    ...
                    this.addObserver(e, {
                        ...
                        e.forEach(e => {
                            "childList" === e.type && e.addedNodes.forEach(e => {
                                if (1 === e.nodeType)
                                    if (e.matches && e.matches(a)) this.addEventListenerTracked(e, "click", e => {
                                        this.handleTopBarClick(e)
                                    });
                                    else {
                                        (e.querySelectorAll ? e.querySelectorAll(a) : []).forEach(e => {
                                            this.addEventListenerTracked(e, "click", e => {
                                                this.handleTopBarClick(e)
                                            })
                                        })
        ...
        1851: (e, t, r) => {
            ...
            var n, i, s, o = r(8473),
                ...
                g = p("iterator"),
                f = !1;
            [].keys && ("next" in (s = [].keys()) ? (i = u(u(s))) !== Object.prototype && (n = i) : f = !0), !c(n) || o(function() {
                var e = {};
                return n[g].call(e) !== e
        ...
        3025: (e, t, r) => {
            ...
            t.DashboardUtils = {
                isElementorPage() {
                    ...
                    if ("elementor_library" === r || "e-floating-buttons" === r) return !0;
        ...
        3617: (e, t, r) => {
            ...
            var n = r(8612),
                ...
                E = function Iterator() {
                    if (s(this, g), c(this) === g) throw new b("Abstract class Iterator not directly constructable")
                },
                defineIteratorPrototypeAccessor = function(e, t) {
                    f ? l(g, e, {
                        ...
                        set: function(t) {
                            if (o(this), this === g) throw new b("You can't redefine this property");
                            p(this, e) ? this[e] = t : u(this, e, t)
                        }
                    }) : g[e] = t
                };
            p(g, y) || defineIteratorPrototypeAccessor(y, _), !S && p(g, v) && g[v] !== Object || defineIteratorPrototypeAccessor(v, E), E.prototype = g, n({
                global: !0,
                constructor: !0,
                forced: S
            }, {
        ...
        3827: (e, t, r) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = t.SCREEN_TYPES = t.NAV_AREAS = t.CONTROL_TYPES = void 0, r(5724), r(4846), r(9655);
            var i = n(r(6336)),
                s = n(r(7011)),
                o = n(r(4077)),
                a = n(r(7670)),
            ...
            class WpDashboardTracking {
                ...
                static init() {
                    this.initialized || (this.restoreOrCreateSession(), this.isEventsManagerAvailable() && (this.startSessionMonitoring(), this.attachActivityListeners(), this.attachNavigationListener(), this.initialized = !0))
                }
                static restoreOrCreateSession() {
                    const e = this.getStoredSession();
                    e ? (this.sessionStartTime = e.sessionStartTime, this.navItemsVisited = new Set(e.navItemsVisited), this.lastActivityTime = Date.now(), this.sessionEnded = !1) : (this.sessionStartTime = Date.now(), this.lastActivityTime = Date.now(), this.sessionEnded = !1, this.navItemsVisited = new Set), this.processPendingNavClick(), this.saveSessionToStorage()
                }
                static processPendingNavClick() {
                    try {
                        ...
                        if (e) {
                            ...
                            const i = {
                                wpdash_nav_item_id: t,
                                wpdash_nav_area: n
                            };
                            r && (i.wpdash_nav_item_root = r), this.dispatchEvent("wpdash_nav_clicked", i, {
                                send_immediately: !0
                ...
                static dispatchEvent(e, t = {}, r = {}) {
                    this.isEventsManagerAvailable() && this.canSendEvents() && elementorCommon.eventsManager.dispatchEvent(e, t, r)
                }
                ...
                static startSessionMonitoring() {
                    this.activityCheckInterval = setInterval(() => {
                        ...
                        this.sessionEnded || this.isNavigatingToElementor || this.trackSessionEnd("tab_closed")
                    }), document.addEventListener("visibilitychange", () => {
                        if (!this.sessionEnded && document.hidden) {
                            Date.now() - this.lastActivityTime > d && this.trackSessionEnd("tab_inactive")
                        }
                    })
                }
                static isElementorPage(e) {
                    try {
                        ...
                        return r && ["elementor", "go_knowledge_base_site", "e-form-submissions"].some(e => r.includes(e)) || n && s.includes(n) || i && i.includes("elementor")
                    } catch (e) {
                        return !1
                    }
                }
                static isPluginsPage(e) {
                    try {
                        return new URL(e, window.location.origin).pathname.includes("plugins.php")
                    } catch (e) {
                        return !1
                    }
                }
                ...
                static attachNavigationListener() {
                    const handleLinkClick = e => {
                            ...
                            if (t && t.href) {
                                ...
                                !this.sessionEnded && this.isNavigatingAwayFromElementor(t.href) ? this.trackSessionEnd("navigate_away") : this.isElementorPage(t.href) && (this.isNavigatingToElementor = !0)
                            }
                        },
                        handleFormSubmit = e => {
                            const t = e.target;
                            t.action && (!this.sessionEnded && this.isNavigatingAwayFromElementor(t.action) ? this.trackSessionEnd("navigate_away") : this.isElementorPage(t.action) && (this.isNavigatingToElementor = !0))
                        };
                    document.addEventListener("click", handleLinkClick, !0), document.addEventListener("submit", handleFormSubmit, !0), this.navigationListeners.push({
                        type: "click",
                ...
                static checkSessionTimeout() {
                    Date.now() - this.lastActivityTime > d && !this.sessionEnded && this.trackSessionEnd("timeout")
                }
                ...
                static trackNavClicked(e, t = null, r = g.LEFT_MENU) {
                    ...
                    this.updateActivity(), this.navItemsVisited.add(e), this.saveSessionToStorage();
                    const n = {
                ...
                static trackSessionEnd(e = "timeout") {
                    ...
                    this.sessionEnded = !0, this.activityCheckInterval && (clearInterval(this.activityCheckInterval), this.activityCheckInterval = null);
                    ...
                    this.dispatchEvent("wpdash_session_end_state", r), this.clearStoredSession()
                }
                static destroy() {
                    this.activityCheckInterval && clearInterval(this.activityCheckInterval), this.navigationListeners.forEach(({
                        type: e,
                        handler: t
                    }) => {
                        document.removeEventListener(e, t, !0)
                    }), this.navigationListeners = [], c.default.destroy(), a.default.destroy(), o.default.destroy(), l.default.destroy(), u.default.destroy(), this.initialized = !1
                }
            }
            t.default = WpDashboardTracking, window.addEventListener("elementor/admin/init", () => {
                ...
                t && s.default.init(), i.default.init(), r && (WpDashboardTracking.init(), c.default.init(), a.default.init(), o.default.init(), l.default.init(), u.default.init())
            }), window.addEventListener("beforeunload", () => {
                i.default.destroy(), s.default.destroy(), WpDashboardTracking.destroy()
            })
        },
        3864: (e, t, r) => {
            "use strict";
        ...
        4077: (e, t, r) => {
            ...
            var i = n(r(3827)),
                s = n(r(6349));
            const o = ".e-feature-promotion, .elementor-settings-form-page, #elementor-element-manager-wrap",
            ...
            class PromotionTracking extends s.default {
                ...
                static extractPromoPath() {
                    ...
                    return e ? e.replace("elementor_", "").replace(/_/g, "/") : "elementor"
                }
            }
        ...
        4543: (e, t, r) => {
            ...
            class ActionControlTracking extends o.default {
                static init() {
                    s.DashboardUtils.isElementorPage() && (this.attachDelegatedHandlers(), this.addTrackingAttributesToFilterButtons(), this.initializeLinkDataIds())
                }
                static initializeLinkDataIds() {
                    const initializeLinks = () => {
                        document.querySelectorAll("a[href]").forEach(e => {
                            if (this.isExcludedElement(e) || this.isNavigationLink(e) || e.hasAttribute("data-id")) return;
                    ...
                    "loading" === document.readyState ? document.addEventListener("DOMContentLiteSpeedLoaded", initializeLinks) : initializeLinks()
                }
                static addTrackingAttributesToFilterButtons() {
                    ...
                    const addDataIdToListTableButtons = () => {
                        [{
                            ...
                            r && !r.hasAttribute("data-id") && r.setAttribute("data-id", `${t}-button-${e.suffix}`)
                        })
                    };
                    "loading" === document.readyState ? document.addEventListener("DOMContentLiteSpeedLoaded", addDataIdToListTableButtons) : addDataIdToListTableButtons()
                }
                ...
                static attachDelegatedHandlers() {
                    ...
                    this.addEventListenerTracked(document, "click", t => {
                        const r = t.target && 1 === t.target.nodeType ? t.target : t.target ? .parentElement;
                        if (!r) return;
                        const n = r.closest('button, input[type="submit"], input[type="button"], .button, .e-btn');
                        if (n && !this.isExcludedElement(n)) return e.includes(n.id) ? void this.trackControl(n, i.CONTROL_TYPES.FILTER) : void this.trackControl(n, i.CONTROL_TYPES.BUTTON);
                        const s = r.closest("a");
                        !s || this.isExcludedElement(s) || this.isNavigationLink(s) || this.trackControl(s, i.CONTROL_TYPES.LINK)
                    }, {
                        capture: !1
                        ...
                        if (r && !this.isExcludedElement(r)) return void this.trackControl(r, i.CONTROL_TYPES.TOGGLE);
                        const n = t.closest('input[type="checkbox"]');
                        if (n && !this.isExcludedElement(n)) return void this.trackControl(n, i.CONTROL_TYPES.CHECKBOX);
                        const s = t.closest('input[type="radio"]');
                        if (s && !this.isExcludedElement(s)) return void this.trackControl(s, i.CONTROL_TYPES.RADIO);
                        const o = t.closest("select");
                        o && !this.isExcludedElement(o) && this.trackControl(o, i.CONTROL_TYPES.SELECT)
                    })
                }
                ...
                static extractControlIdentifier(e, t) {
                    ...
                    if (i.CONTROL_TYPES.CHECKBOX === t) {
                        const t = e.getAttribute("name");
                        if (t) {
                            if (document.querySelectorAll(`input[type="checkbox"][name="${CSS.escape(t)}"]`).length > 1) {
                    ...
                    if (i.CONTROL_TYPES.BUTTON === t || i.CONTROL_TYPES.TOGGLE === t || i.CONTROL_TYPES.FILTER === t) {
                        const t = e.getAttribute("data-id");
                        if (t) return t;
                ...
                static extractClassId(e) {
                    ...
                    const r = t.split(" ");
                    for (const e of r)
                        if (e.startsWith("e-id-")) return e.substring(5);
                    return ""
                }
                static removeNonceFromUrl(e) {
                    try {
                        ...
                        return null !== r && /^[0-9]+$/.test(r) && t.searchParams.delete("post"), t.pathname + t.search + t.hash
                    } catch (t) {
                        return e
                    }
                }
            ...
            class NavigationTracking extends s.default {
                ...
                static determineNavArea(e) {
                    if (e.closest("li.menu-top")) {
                        if (e.closest(c)) {
                            return e.closest(l).classList.contains("wp-not-current-submenu") ? i.NAV_AREAS.HOVER_MENU : i.NAV_AREAS.SUBMENU
                        }
        ...
        6349: (e, t, r) => {
            ...
            t.default = class BaseTracking {
                static ensureOwnArrays() {
                    Object.prototype.hasOwnProperty.call(this, "observers") || (this.observers = []), Object.prototype.hasOwnProperty.call(this, "eventListeners") || (this.eventListeners = [])
                }
                static destroy() {
                    this.ensureOwnArrays(), this.observers.forEach(e => e.disconnect()), this.observers = [], this.eventListeners.forEach(({
                        target: e,
                        type: t,
                        handler: r,
                        options: n
                ...
                static addEventListenerTracked(e, t, r, n = {}) {
                    this.ensureOwnArrays(), e.addEventListener(t, r, n), this.eventListeners.push({
                        target: e,
                        type: t,
                        handler: r,
                        options: n
        ...
        7011: (e, t, r) => {
            ...
            class PluginActions extends s.default {
                ...
                static init() {
                    this.attachCoreDeactivationTracking(), this.attachProDeactivationTracking(), this.attachProDeletionTracking()
                }
                static attachCoreDeactivationTracking() {
                    const e = document.querySelector("#elementor-deactivate-feedback-dialog-form");
                    e && (this.addEventListenerTracked(e, "change", e => {
                        const t = e.target;
                        t.classList.contains("elementor-deactivate-feedback-dialog-input") && (this.selectedReason = t.value)
                    }), this.observeModalButtons())
                }
                static attachProDeactivationTracking() {
                    const e = document.querySelector(".plugins");
                    e && this.addEventListenerTracked(e, "click", e => {
                        const t = e.target.closest("a");
                        t && "deactivate-elementor-pro" === t.id && this.trackProDeactivation()
                    }, {
                        capture: !0
                    })
                }
                static observeModalButtons() {
                    const checkAndAttachDelegation = () => {
                        const e = document.querySelector("#elementor-deactivate-feedback-modal");
                        return !!e && (this.addEventListenerTracked(e, "click", e => {
                            const t = e.target.closest(".dialog-submit"),
                                r = e.target.closest(".dialog-skip");
                            t ? this.trackCoreDeactivation("submit&deactivate") : r && this.trackCoreDeactivation("skip&deactivate")
                        }, {
                            capture: !0
                        }), !0)
                    };
                    checkAndAttachDelegation() || this.addObserver(document.body, {
                        childList: !0,
                        subtree: !0
                    }, (e, t) => {
                ...
                static getUserInput() {
                    ...
                    const e = document.querySelector(`input[name="reason_${this.selectedReason}"]`);
                    return e && e.value ? e.value : null
                }
                static trackCoreDeactivation(e) {
                    const t = {
                        deactivate_form_submit: e,
                        deactivate_plugin_type: o
                    };
                    this.selectedReason && (t.deactivate_feedback_reason = this.selectedReason);
                    const r = this.getUserInput();
                    r && (t.deactivate_feedback_reason += `/${r}`), i.default.dispatchEvent("wpdash_deactivate_plugin", t, {
                        send_immediately: !0
                    })
                }
                ...
                static attachProDeletionTracking() {
                    "undefined" != typeof jQuery && jQuery(document).on("wp-plugin-deleting", (e, t) => {
                        "elementor-pro" === t ? .slug && this.trackProAction("delete")
                    })
                }
                static destroy() {
                    "undefined" != typeof jQuery && jQuery(document).off("wp-plugin-deleting"), s.default.destroy.call(this)
                }
                static trackProAction(e) {
                    ...
                    i.default.dispatchEvent(t.eventName, r, {
                        send_immediately: !0
                    })
                }
            }
        ...
        7670: (e, t, r) => {
            ...
            const a = ".nav-tab-wrapper",
                ...
                p = ["#elementor-new-floating-elements-modal", "#elementor-new-template-dialog-content"];
            class ScreenViewTracking extends o.default {
                ...
                static getScreenData() {
                    ...
                    let s = "",
                        o = "";
                    if (s = t || (r || this.getScreenIdFromBody()), this.isElementorAppPage()) {
                ...
                static attachTabChangeTracking() {
                    this.attachNavTabTracking(), this.attachHashChangeTracking(), this.attachSettingsTabTracking(), this.attachModalTracking()
                }
                ...
                static attachModalTracking() {
                    this.addObserver(document.body, {
                        ...
                        for (const t of e) "childList" === t.type && p.forEach(e => {
                ...
                static trackScreen(e, t = i.SCREEN_TYPES.TOP_LEVEL_PAGE) {
                    const r = `${e}-${t}`;
                    this.trackedScreens.has(r) || (this.trackedScreens.add(r), i.default.trackScreenViewed(e, t))
                }
            }
        ...
        8660: (e, t, r) => {
            ...
            s(w, g, "Iterator Helper"), e.exports = function(e, t, r) {
                var n = function Iterator(n, i) {
                    i ? (i.iterator = n.iterator, i.next = n.next) : i = n, i.type = t ? m : f, i.returnHandlerResult = !!r, i.nextHandler = e, i.counter = 0, i.done = !1, y(this, i)
                };
