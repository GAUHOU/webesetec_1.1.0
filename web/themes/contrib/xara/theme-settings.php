...
function xara_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#upload_validators' => array(
      'FileExtension' => array('gif png jpg jpeg svg gif webp'),
    ),
  ...
  $form['header']['header_links']['header_topbar_show'] = [
    ...
    '#default_value' => theme_get_setting('header_topbar_show', 'xara'),
  ...
  $form['header']['sticky_header']['sticky_header_option']['sticky_header_enable'] = [
    ...
    '#default_value' => theme_get_setting('sticky_header_enable', 'xara'),
